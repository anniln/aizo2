#include "PrimAlgorithmOnUndirectedMatrixGraphTester.h"

int PrimAlgorithmOnUndirectedMatrixGraphTester::MinKey(unsigned key[], bool mstSet[], int V)
{
...
std::string PrimAlgorithmOnUndirectedMatrixGraphTester::TestGraphAlgorithm(const MatrixGraph& graph,
